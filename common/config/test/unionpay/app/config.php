...
return [
    ...
    'SDK_VERIFY_CERT_DIR' => '/home/yanhuaguo/unionpay/assets/cert/',
    ...
    // 前台通知地址 (商户自行配置通知地址)
    'SDK_FRONT_NOTIFY_URL' => 'http://dev.vt.api.v-town.cn:8601/demo/api_01_gateway/FrontReceive.php',

    // 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
    // SDK_BACK_NOTIFY_URL = 'http://dev.vt.api.v-town.cn:8601/demo/api_01_gateway/BackReceive.php',
    'SDK_BACK_NOTIFY_URL' => 'http://unionpay.vt.pay.v-town.cn/index.php',

    //文件下载目录
    'SDK_FILE_DOWN_PATH' => '/home/yanhuaguo/unionpay/assets/file',
