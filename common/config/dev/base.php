...
//支付网关地址
define('DOMAIN_PAY', 'http://dev.pay.' . DOMAIN);
//文件地址
...
//API域地址
define('DOMAIN_API', 'http://dev.api.' . DOMAIN);
//static域
define('DOMAIN_STATIC', 'http://dev.static.admin.' . DOMAIN);
//h5域
define('DOMAIN_H5', 'http://dev.static.h5.' . DOMAIN);

define('DOMAIN_H5_SHARE', 'http://dev.static.h5.abctime.com/mystory/index.html?');
//GzhAPI域地址
define('DOMAIN_GZH_API', 'http://dev.gzh.'.DOMAIN);
//WWW域地址
define('DOMAIN_WWW', 'http://dev.www.' . DOMAIN);
// story 音频地址
...
define('VERSION', 8);
//审核phone版本号
define('PHONE_VERSION', 44);
//兼容版本号
define('OLD_VERSION', 44);
//测试发短信
